...
?>
<li<?php echo $noimg?' class="noimg"':'' ?>><a<?php echo _post_target_blank() ?> href="<?php the_permalink(); ?>"><?php if( $img && !$noimg ){echo '<span class="thumbnail">'; echo $pic; echo '</span>'; } ?><span class="text"><?php the_title(); ?><?php echo get_the_subtitle() ?></span><span class="muted"><?php the_time('Y-m-d');?></span><?php if( !_hui('kill_comment_s') && $comn ){ ?><span class="muted"><?php echo '评论(', comments_number('0', '1', '%'), ')'; ?></span><?php } ?></a></li>
<?php
