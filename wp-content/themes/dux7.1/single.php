...
<section class="container">
	...
	<div class="content">
		...
		<article class="article-content">
			...
			<?php if( hui_is_post_modified() ) echo '<div class="article-update-tips">本文于 '.get_the_modified_date('Y-m-d H:i').' 更新，'._hui('single_update_tip').'</div>'; ?>
			<?php the_content(); ?>
		</article>
        ...
        <?php } ?>
		<?php if( _hui('post_copyright_on')=='simple' ){
		...
		}elseif( _hui('post_copyright_on')=='custom' ){
			$pccode = _hui('post_copyright_custom');
			$pccode = str_replace("\n", '<br>', $pccode);
			$pccode = str_replace("%POSTNAME%", get_the_title(), $pccode);
			$pccode = str_replace("%POSTLINK%", get_the_permalink(), $pccode);
			echo '<div class="post-copyright-custom">' . $pccode . '</div>';
		} ?>
		<?php endwhile; ?>
